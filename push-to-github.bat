...
echo.
echo  Committing...
git commit -m "Summer Bonus: office card grid drill-down, per-office icons (custom arch SVG for S. Utah), gold card borders, hide non-qualifying week deals in detail panel"
echo.
